...
import { sampleWithRequiredData } from '../professor-details.test-samples';
...
describe('ProfessorDetails Management Component', () => {
  let comp: ProfessorDetailsComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(ProfessorDetailsComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.professorDetails?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to professorDetailsService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getProfessorDetailsIdentifier');
      const id = comp.trackId(entity);
      expect(service.getProfessorDetailsIdentifier).toHaveBeenCalledWith(entity);
