...
import { sampleWithRequiredData } from '../exam-session.test-samples';
...
describe('ExamSession Management Component', () => {
  let comp: ExamSessionComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(ExamSessionComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.examSessions?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to examSessionService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getExamSessionIdentifier');
      const id = comp.trackId(entity);
      expect(service.getExamSessionIdentifier).toHaveBeenCalledWith(entity);
