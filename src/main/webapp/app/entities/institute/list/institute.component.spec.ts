...
import { sampleWithRequiredData } from '../institute.test-samples';
...
describe('Institute Management Component', () => {
  ...
  describe('trackId', () => {
    it('Should forward to instituteService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getInstituteIdentifier');
      const id = comp.trackId(entity);
      expect(service.getInstituteIdentifier).toHaveBeenCalledWith(entity);
