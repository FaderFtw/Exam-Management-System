...
import static tn.fst.exam_manager.security.SecurityUtils.AUTHORITIES_KEY;
import static tn.fst.exam_manager.security.SecurityUtils.JWT_ALGORITHM;
...
public class JwtAuthenticationTestUtils {
    ...
    public static String createValidTokenForUser(String jwtKey, String user) {
        ...
        JwtClaimsSet claims = JwtClaimsSet.builder()
            ...
            .subject(user)
            .claims(customClaim -> customClaim.put(AUTHORITIES_KEY, Collections.singletonList("ROLE_SUPER_ADMIN")))
            .build();
